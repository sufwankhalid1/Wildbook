...
-- find constraint-breaking ids in RELATIONSHIP
select "MARKEDINDIVIDUALNAME1" from "RELATIONSHIP" where "MARKEDINDIVIDUALNAME1" not in (select "INDIVIDUALID" from "MARKEDINDIVIDUAL");
select "MARKEDINDIVIDUALNAME2" from "RELATIONSHIP" where "MARKEDINDIVIDUALNAME2" not in (select "INDIVIDUALID" from "MARKEDINDIVIDUAL");
