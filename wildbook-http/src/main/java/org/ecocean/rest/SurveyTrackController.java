...
//    public ResponseEntity<SurveyPart> appendPoints(final HttpServletRequest request,
//                                                    @RequestBody final List<Point> points,
//                                                    @PathVariable("surveyTrackId") final int surveyTrackId) {
//
//        PersistenceManager pm = getPM(request);
//        SurveyPart track = null;
//        try {
//          track = pm.getObjectById(SurveyPart.class, surveyTrackId);
//        } catch (Exception ex) {
//        }
//
//        if (track == null) {
//            return new ResponseEntity<SurveyPart>(track, HttpStatus.NOT_FOUND);
//        } else {
...
//            return new ResponseEntity<SurveyPart>(track, HttpStatus.OK);
//        }
//    }
//
//
//    @RequestMapping(value = "/appendMedia/{surveyTrackId}", method = RequestMethod.POST)
//    public ResponseEntity<SurveyPart> appendMedia(final HttpServletRequest request,
