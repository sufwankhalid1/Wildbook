...
<%@ page contentType="text/html; charset=utf-8" language="java"
      ...
      <div id="leftcol">
        <div id="menu">
          ...
          <div class="module">
            <h3>Supporters</h3>
            <image width="190px" height="*" src="http://www.splashcatalog.org/shepherd_data_dir/images/ONR_Logo_lg.jpeg" /><br />
	    	              <image width="190px" height="*" src="http://www.splashcatalog.org/shepherd_data_dir/images/PL-Foundation-Logo-300x205.jpg" /><br />
	              <image width="190px" height="*" src="http://www.splashcatalog.org/shepherd_data_dir/images/SPLASH-logo2.jpg" /><br />
</span> <br/>
          </div>
