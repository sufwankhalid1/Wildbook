 ...
 <%=viewing %>: <%=lowCount%> - <%=highCount%><%=displaySort%></td>
	...
	<tr class="lineitem">
		...
		<%}%>
				...
				<td align="left" valign="top" bgcolor="#99CCFF" class="lineitem"><strong>Season
		</strong>
		...
		<td align="left" valign="top" bgcolor="#99CCFF" class="lineitem"><strong>Best Fluke</strong>
	...
	<tr class="lineitems">
		...
		<%
		String season="";
		if(enc.getVerbatimEventDate()!=null){season=enc.getVerbatimEventDate();}
		%>
		<td class="lineitems"><%=season %></td>
	...
	%>
		<td class="lineitems"><%=bestFluke%></td>
