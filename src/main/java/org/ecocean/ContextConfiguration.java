...
public static Properties getContextsProperties(){
  ...
  public static String getDataDirForContext(final String context){
    initialize();
    if(props.getProperty((context+"DataDir"))!=null){return props.getProperty((context+"DataDir"));}
    return null;
  }

  public static String getNameForContext(final String context){
    initialize();
  ...
  public static ArrayList<String> getContextDomainNames(final String contextName){
    initialize();
