...
public class StartupWildbook implements ServletContextListener {
  ...
  public static void ensureProfilePhotoKeywordExists(Shepherd myShepherd) {
    ...
    public static void createMatchGraph(){
      ...
      es.execute(new MatchGraphCreationThread("SELECT FROM org.ecocean.Encounter WHERE (( locationID == \"1a1\" || locationID == \"1a2\" || locationID == \"1a\") &&   dateInMilliseconds <= 1262217600000) || locationID == \"2a\" || locationID == \"2b\" || locationID == \"4a1\""));
    }
