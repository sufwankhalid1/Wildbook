...
*/
    ...
    @RequestMapping(value = "/addPoints/id/{surveyTrackId}", method = RequestMethod.POST)
      public ResponseEntity<SurveyTrack> addPoints(final HttpServletRequest request,
        ...
        SurveyTrack track = (SurveyTrack) pm.getObjectById(SurveyTrack.class, surveyTrackId);
    System.out.println(surveyTrackId);
...
/*
    @RequestMapping(value = "/addPoints/id/{surveyTrackId}", method = RequestMethod.POST, headers = "Accept=*")
		public boolean addPoints(@RequestBody List<Point> points,
                     @PathVariable("surveyTrackId") final long surveyTrackId) {
...
System.out.println("hello? " + surveyTrackId);
