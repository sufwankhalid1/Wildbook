 ...
 */
    ...
    if (request.getParameter("hasTissueSample") != null) {
      ...
      } else if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.TissueSample dce")) {
    ...
    if (request.getParameter("hasPhoto") != null) {
      ...
      if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
        filter += "images.contains(dce15)";
      } else if (filter.indexOf("images.contains(dce15)") == -1) {
        filter += (" && images.contains(dce15) ");
      }

      prettyPrint.append("<br />");
      if (jdoqlVariableDeclaration.equals("")) {
        jdoqlVariableDeclaration = " VARIABLES org.ecocean.SinglePhotoVideo dce15";
      } else if (!jdoqlVariableDeclaration.contains("org.ecocean.SinglePhotoVideo dce15")) {
        jdoqlVariableDeclaration += ";org.ecocean.SinglePhotoVideo dce15";
      }
    ...
    if ((keywords != null) && (!keywords[0].equals("None"))) {
      ...
      locIDFilter += " )";
      if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
        filter += "images.contains(photo) && photo.keywords.contains(word) && " + locIDFilter;
      } else {
        if (filter.indexOf("images.contains(photo)") == -1) {
          filter += " && images.contains(photo)";
        }

        if (filter.indexOf("photo.keywords.contains(word)") == -1) {
          filter += " && photo.keywords.contains(word)";
        }
        filter += (" && " + locIDFilter);
      }
      ...
      prettyPrint.append("<br />");
      if (jdoqlVariableDeclaration.equals("")) {
        jdoqlVariableDeclaration = " VARIABLES org.ecocean.SinglePhotoVideo photo;org.ecocean.Keyword word";
      } else {
        if (!jdoqlVariableDeclaration.contains("org.ecocean.SinglePhotoVideo photo")) {
          jdoqlVariableDeclaration += ";org.ecocean.SinglePhotoVideo photo";
        }
        if (!jdoqlVariableDeclaration.contains("org.ecocean.Keyword word")) {
          jdoqlVariableDeclaration += ";org.ecocean.Keyword word";
        }
      }
    ...
    for (int h = 0; h < numMarkers; h++) {
      ...
      if (request.getParameter(marker) != null) {
        ...
        if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
          filter += "tissueSamples.contains(dce) && dce.analyses.contains(msanalysis) && msanalysis.loci.contains(" + marker + ") && " + locIDFilter;
        } else {
          ...
          if (filter.indexOf("msanalysis.loci.contains(" + marker + ")") == -1) {
            filter += " && msanalysis.loci.contains(" + marker + ")";
          }
        ...
        if (jdoqlVariableDeclaration.equals("")) {
          jdoqlVariableDeclaration = " VARIABLES org.ecocean.genetics.TissueSample dce;org.ecocean.genetics.MicrosatelliteMarkersAnalysis msanalysis;org.ecocean.genetics.Locus " + marker;
        } else {
          if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.TissueSample dce")) {
            jdoqlVariableDeclaration += ";org.ecocean.genetics.TissueSample dce";
          }
          if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.MitochondrialDNAAnalysis analysis")) {
            jdoqlVariableDeclaration += ";org.ecocean.genetics.MicrosatelliteMarkersAnalysis msanalysis";
          }
          if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.Locus " + marker)) {
            jdoqlVariableDeclaration += ";org.ecocean.genetics.Locus " + marker;
          }
    ...
    if ((request.getParameter("alternateIDField") != null) && (!request.getParameter("alternateIDField").equals(""))) {
      ...
      if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
        filter += "otherCatalogNumbers.startsWith('" + altID + "')";
      } else {
        filter += " && otherCatalogNumbers.startsWith('" + altID + "')";
      }
    ...
    if ((haplotypes != null) && (!haplotypes[0].equals("None"))) {
      ...
      locIDFilter += " )";
      if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
        filter += "tissueSamples.contains(dce) && dce.analyses.contains(analysis) && " + locIDFilter;
      } else {
        if (filter.indexOf("tissueSamples.contains(dce)") == -1) {
          filter += " && tissueSamples.contains(dce)";
        }
      ...
      prettyPrint.append("<br />");
      if (jdoqlVariableDeclaration.equals("")) {
        jdoqlVariableDeclaration = " VARIABLES org.ecocean.genetics.TissueSample dce;org.ecocean.genetics.MitochondrialDNAAnalysis analysis";
      } else {
        if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.TissueSample dce")) {
          jdoqlVariableDeclaration += ";org.ecocean.genetics.TissueSample dce";
        }
        if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.MitochondrialDNAAnalysis analysis")) {
          jdoqlVariableDeclaration += ";org.ecocean.genetics.MitochondrialDNAAnalysis analysis";
        }
    ...
    if ((genSexes != null) && (!genSexes[0].equals("None"))) {
      ...
      locIDFilter += " )";
      if (filter.equals(SELECT_FROM_ORG_ECOCEAN_ENCOUNTER_WHERE)) {
        filter += "tissueSamples.contains(dce9) && dce9.analyses.contains(sexanalysis) && " + locIDFilter;
      } else {
      ...
      prettyPrint.append("<br />");
      if (jdoqlVariableDeclaration.equals("")) {
        jdoqlVariableDeclaration = " VARIABLES org.ecocean.genetics.TissueSample dce9;org.ecocean.genetics.SexAnalysis sexanalysis";
      } else {
        ...
        if (!jdoqlVariableDeclaration.contains("org.ecocean.genetics.SexAnalysis analysis")) {
    ...
    if ((request.getParameter("filenameField") != null) && (!request.getParameter("filenameField").equals(""))) {
      ...
      for (int q = 0; q < rEncounters.size(); q++) {
        ...
        for (int i = 0; i < numPhotos; i++) {
          ...
          if (thisPhoto.equals(nameString)) {
            hasPhoto = true;
          }
        }
        if (!hasPhoto) {
