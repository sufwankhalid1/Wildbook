...
/*
 * An almost entirely public static / functional class for printing html UI elements
 * for editing class fields on pages such as occurrence.jsp.
 */
...
public class ClassEditTemplate {
  ...
  public static void updateObjectField(Object obj, String setterName, String valueAsString) throws NoSuchMethodException {
    try {
      ...
      if (c == Double.class){
        ...
        System.out.println("objURRENCE.JSP: just invoked "+setterName+" with value "+dbl);
      }
      ...
      if (c == Integer.class){
        ...
        System.out.println("objURRENCE.JSP: just invoked "+setterName+" with value "+in);
      }
      ...
      if (c == Boolean.class){
        ...
        System.out.println("objURRENCE.JSP: just invoked "+setterName+" with value "+bo);
      }

      if (c == String.class){
        Method setter = obj.getClass().getMethod(setterName, String.class);
        setter.invoke(obj, valueAsString);
        System.out.println("objURRENCE.JSP: just invoked "+setterName+" with value "+valueAsString);
      }
      ...
      if (c == DateTime.class){
        ...
        System.out.println("objURRENCE.JSP: just invoked "+setterName+" with value "+dt);

      }
    } catch (Exception e) {
      System.out.println("objURRENCE.JSP: was not able to invoke "+setterName+" with value "+valueAsString);
      e.printStackTrace();
    }
  }
  ...
  public static void printDateTimeSetterRow(Object obj, javax.servlet.jsp.JspWriter out) throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException {
    ...
    System.out.println("\t<td>"+fieldName+"</td>");
    ...
    System.out.println("<input class=\"form-control\" type=\"text\" id=\"datepicker\"");
  ...
  public static void printOutClassFieldModifierRow(Object obj, Method getMethod, javax.servlet.jsp.JspWriter out) throws IOException, IllegalAccessException, InvocationTargetException {
    ...
    System.out.println("<td class=\"undo-container\">");
    System.out.println("<div title=\"undo this change\" class=\"undo-button\">&#8635;</div>");
    System.out.println("</td>");
