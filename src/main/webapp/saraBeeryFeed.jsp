...
String filter="SELECT FROM org.ecocean.MarkedIndividual WHERE encounters.contains(enc) && ( enc.locationID == 'Mpala' || enc.locationID == 'Mpala.North' || enc.locationID == 'Mpala.Central' || enc.locationID == 'Mpala.South' || enc.locationID == 'Ol Pejeta' || enc.locationID == 'Ol Pejeta.East' || enc.locationID == 'Ol Pejeta.West' ) && encounters.contains(enc464) && enc464.annotations.contains(annot2) && annot2.features.contains(feat2) && feat2.asset != null VARIABLES org.ecocean.Encounter enc;org.ecocean.Encounter enc464;org.ecocean.Annotation annot2;org.ecocean.media.Feature feat2";
