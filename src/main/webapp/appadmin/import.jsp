...
%>
  ...
  <tr>
    ...
    <p>This importer is custom-built for the excel files used by the EWT team.</p>
	<p><img src="../images/Warning_icon.png" width="25px" height="*" align="absmiddle" /> <em>Importing an Excel file may override existing data and cause data loss.</em></p>
	<p>
		<!--  ignore this comment -->
