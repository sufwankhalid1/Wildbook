...
<%
	...
	try {
		...
		gpo = new GrothParameterOptimizer();
                ...
                gpo.getGrothAnalysis().setNumCPUs(8);
                ...
                //default Modified Groth settings from 2005
                gpo.writeResultsToFile(new double[] {0.01, 50, 0.9999, 10, 0.99}, 500, 1000);
                
                //new settings for testing
                //gpo.writeResultsToFile(new double[] {0.008, 49.8, 0.998, 12.33, 0.998}, 500, 2000);
