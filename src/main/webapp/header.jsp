  ...
  <ul id="pmenu">
    ...
    <li class="drop"><a
      ...
      <ul>
        ...
        <li><a
          href="http://<%=CommonConfiguration.getURLLocation(request) %>/encounters/allEncountersUnapproved.jsp?start=1&end=10&sort=nosort"
          class="enclose"
        ...
        <li>
          <a
            href="http://<%=CommonConfiguration.getURLLocation(request) %>/encounters/allEncounters.jsp?start=1&end=10&sort=nosort&rejects=true"
            class="enclose"
