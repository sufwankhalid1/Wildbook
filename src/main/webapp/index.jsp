...
if (!CommonConfiguration.isWildbookInitialized(myShepherd)) {
    System.out.println("-- Wildbook not initialized. Starting Wildbook. --");
...
<section class="hero container-fluid main-section relative">
    <div class="container relative">
        <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
            <h2>Wildbook for the Andy Read lab.</h2>
            <!--
    ...
    <section class="container text-center  main-section">
        <div class="row">
            <section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 padding">
                <p class="brand-primary"><i><span class="massive"><%=numMarkedIndividuals %></span> identified animals</i></p>
            </section>
            <section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 padding">
